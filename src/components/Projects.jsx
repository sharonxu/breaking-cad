function Projects({ scrollY }) {
  ...
  const projects = [
    {
      title: "VIBE CAD",
      description: "Breaking CAD's AI-native design workflow: describe what you want (and optionally provide reference images) to generate manufacturing-ready geometry and files (CAD, STL, SVG). Built for fast iteration with real fabrication constraints - turn intent into parts you can actually make. Powered by a novel architecture that reasons about sketches, constraints, and fabrication rules, grounded in extensive engineering data gathered through real builds, process specifications, and vendor/tooling catalogs. Produces edit-ready SVG and CAD while respecting tolerances, clearances, and stock sizes.",
