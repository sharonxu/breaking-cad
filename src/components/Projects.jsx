function Projects({ scrollY }) {
  ...
  const projects = [
    {
      title: "VIBE CAD",
      description: "Breaking CAD's AI-native design workflow: speak your vision into existence. Describe what you want to build and/or provide reference images, and iterate to refine requirements step by step until the design is right. The system produces manufacture-ready design files (CAD, STL, SVG) that you can preview at any point in the process. Powered by a novel architecture with strong natural language understanding and spatial reasoning, our system can reason about sketches, constraints, and fabrication rules. Training data includes prompt-to-CAD/SVG pairs gathered through third-party annotation services like DataAnnotation and Scale AI, combined with engineering data from real builds, process specifications, and vendor catalogs. Produces manufacture-ready files while respecting tolerances, clearances, and stock sizes.",
