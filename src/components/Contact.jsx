function Contact() {
  return (
    <section id="contact" className="min-h-screen flex items-center pt-56 pb-24 px-6 md:px-12 border-t border-steel/20">
          ...
          <div className="space-y-6">
            <div className="border-2 border-steel/40 p-6 hover:border-machine-orange transition-colors group">
              ...
              <a 
                ...
                className="text-2xl font-black group-hover:text-machine-orange transition-colors flex items-center gap-3"
              >
