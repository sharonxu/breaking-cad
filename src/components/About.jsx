function About({ scrollY }) {
  ...
  return (
    <section id="about" className="min-h-screen flex items-center relative py-24 px-6 md:px-12 border-t border-steel/20">
        ...
        <div className="grid md:grid-cols-2 gap-24 items-center">
          ...
          >
            ...
            <div className="border-l-4 border-steel pl-6">
              <div className="text-5xl font-black font-mono mb-2">½"</div>
